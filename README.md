...
2. Run the command `npm install` on terminal in current direction(where this README file is located)
3. Run the command `npm run start:dev` This should get the app running on http://localhost:3000 - make sure port 3000 on your pc is free or read the port your app is running on from your terminal
